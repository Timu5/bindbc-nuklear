...
extern(C) @nogc nothrow {
    version(NK_INCLUDE_DEFAULT_ALLOCATOR) {
        bool nk_init_default(nk_context*, const(nk_user_font)*);
    }
    bool nk_init_fixed(nk_context*, void* memory, nk_size size, const(nk_user_font)*);
    bool nk_init(nk_context*, nk_allocator*, const(nk_user_font)*);
